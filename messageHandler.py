...
# Tech related
tech_buzzwords = re.compile(r"\bar\b|\bvr\b|\bblock[\s]*chain[s]*\b|\bcrypto\b|\bmachine[\s]*learning\b|\bcloud\b|\bHD\b",
...
# Food / Ameens
food_words= re.compile(r"\bsupper\b|\ba+m+e+n+s*\b|\bmacs+\b|\bcheese[\s]*fries+\b|\border(ing)?\b|\bmala+\b",
                     flags=re.IGNORECASE | re.MULTILINE)
